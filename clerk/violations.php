    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="violations.php" aria-expanded="false" aria-controls="auth">
...
<script>
            ...
            $('#violationsTable').DataTable({
                ...
                "columns": [
                    ...
                    { "data": "status" },
                    {
                        ...
                        "render": function(data, type, row) {
                            return `
                                <button class="btn btn-info btn-sm" onclick="editViolation('${row.violation_no}')">Edit</button>
                                <button class="btn btn-danger btn-sm" onclick="deleteViolation('${row.violation_no}')">Delete</button>
                            `;
                        }
                    }
                ]
        ...
        function editViolation(violation_no) {
            // Handle edit functionality here
            alert('Edit violation for student ID: ' + violation_no);
        }

        function deleteViolation(violation_no) {
            // Handle delete functionality here
            if (confirm('Are you sure you want to delete the violation with violation number : ' + violation_no + '?')) {
              $.ajax({
                url: '../process/delete_violation.php',
                type: 'POST',
                data: { violation_id: violation_no },
