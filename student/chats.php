...
function loadChat(studentId) {
    ...
    $.ajax({
        url: '../process/fetch_chats_students.php',
        method: 'GET',
...
function sendMessage() {
    ...
    if (message && selectedStudentId) {
        $.ajax({
            url: '../process/send_message_students.php',
            method: 'POST',
            data: {
    ...
    $(document).ready(function() {
        ...
        function loadChatList() {
            $.ajax({
                url: '../process/fetch_chat_list_students.php',
                method: 'GET',
                dataType: 'json',
                success: function(data) {
                    ...
                    if (data.length === 0) {
                        ...
                        data.forEach(function(chat) {
                            const chatItem = $(`
                                <div class="chat-item" data-student-id="${chat.mod_id}">
